...
export const countries: CountryFlags[] = [
    ...
    },
    {
        name: "United Kingdom",
        emoji: "🇬🇧",
        alternate_names: ["UK", "United Kingdom of Great Britain and Northern Ireland", "Britain"]
    }, 
    {
        name: "Germany",
        emoji: "🇩🇪",
...
export function isAnswerCorrect(answer: string, country: CountryFlags): boolean {
