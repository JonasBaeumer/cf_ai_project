...
describe("calculateLeaderboard()", () => {
  ...
  it("should include all player information", () => {
    const players = new Map([
      ["alice123", { name: "Alice", totalScore: 500 }]
    ]);
...
describe("Integration: Complete Game Simulation", () => {
  it("should simulate a 3-round game", () => {
    const france: CountryFlags = { name: "France", emoji: "🇫🇷", alternate_names: ["FR"] };
    const germany: CountryFlags = { name: "Germany", emoji: "🇩🇪", alternate_names: ["DE"] };
    const japan: CountryFlags = { name: "Japan", emoji: "🇯🇵", alternate_names: ["JP"] };
